...
<head>
  ...
  <link rel="icon" type="image/png" href="img/1936905_computer_device_mac_pc_work_icon.png"/>
          ...
          <div class="card" style="border-radius: 1rem;">
            <div class="row no-gutters">
              <div class="col-md-7 col-lg-5 d-none d-md-block">
                <img
                  src="https://images.pexels.com/photos/4107120/pexels-photo-4107120.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form>
                    ...
                    <div class="form-outline mb-3">
                      ...
                      <input placeholder="Digite seu CPF" type="text" id="CPF" class="form-control form-control-lg" />
