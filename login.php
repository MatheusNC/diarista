...
<body>
    <section class="vh-100" style="background-color: #cac9b9">
                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row no-gutters">
                            <div class="col-md-7 col-lg-5 d-none d-md-block">
                                <img src="https://images.pexels.com/photos/4107120/pexels-photo-4107120.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" />
                            </div>
                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="form-outline mb-3">
                                            ...
                                            <input placeholder="Digite sua senha" name="senha" type="password" id="Senha" class="form-control form-control-lg " />
                                        </div>
                                        ...
                                        <p class="mb-5 pb-lg-2" style="color: #393f81;">Não tem sua conta? <a href="cadastro.php" target="_blank" style="color: #393f81;">Registre aqui!</a></p>
