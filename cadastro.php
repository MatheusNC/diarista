...
if (isset($_POST['email']) || isset($_POST['senha']) || isset($_POST['repetirSenha']) || isset($_POST['cpf']) || isset($_POST['nome']) || isset($_POST['telefone'])) {
    if (strlen($_POST['email']) == 0) {
        ...
        if ($qtd == 1) {
            ...
            $sql_insert = "INSERT INTO usuario(email,senha,cpf,telefone,nomeCompleto) VALUES('$email', '$senha','$cpf','$tel','$nome')";
                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form method="POST">
                                    ...
                                    <div class="form-outline mb-3">
                                        ...
                                        <input placeholder="Digite sua senha" type="password" name='senha' id="Senha" class="form-control form-control-lg " />

                                    </div>

                                    <div class="form-outline mb-3">
                                        <label class="form-label" for="form2Example27">Confirme sua senha:</label>
                                        <input placeholder="Repita sua senha" type="password" name='repetirSenha' id="RepetirSenha" class="form-control form-control-lg " />
                                    ...
                                    <div class="pt-1 mb-3">
                                        <a href="login.php"><button class="btn btn-dark btn-lg btn-block" type="submit">Cadastrar</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
