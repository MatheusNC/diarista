<?php
    ...
    $consulta = "SELECT A.ID ID, A.Data data, A.Horario horario, A.TipodeServico tipoServico, A.observacoes obs, U.NomeCompleto nome FROM agenda A, usuario U WHERE A.idPrestadorServico = '$id' AND U.ID = '$id';";
...
<body>
    ...
    <h1 class="form-group mt-3 fs-2" style="text-align:center"> Agende com o prestador(a) de acordo com sua disponibilidade</h1>
    <h4 class="form-group mt-3 fs-2" style="text-align:center"> Entre em contato com o(a) prestador(a) abaixo para seu melhor horário:</h4>
    ...
    <table class="table table-striped table-dark">
        ...
        <tbody>
            <?php while($dado = $con->fetch_array()) {?>
                <?php echo "<h2 style=\"justify-content: center; color: white; margin: auto\">"; echo $dado['nome']; echo "</h2>"?>
                    <tr>
                        <td><?php echo $dado["ID"]; ?></td>
                        <td><?php echo date("d/m/Y", strtotime($dado["data"])); ?></td>
                        <td><?php echo $dado["horario"]; ?></td>
                        <td><?php echo $dado["tipoServico"]; ?></td>
